...
import { Activity, Gauge, Globe, Shield, Tv, Zap } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    title: "IPTV Streams",
    description:
      "Manage and access your favorite streaming channels and content",
    href: "/iptv",
  },
  {
    icon: Gauge,
            ...
            >
              ...
              <CardContent>
                <Link href={feature.href}>
                  <Button className="w-full group-hover:glow-cyan transition-all duration-300">
